...
var auditTask = function(taskEl) {
  //to get date from task element
  var date = $(taskEl).find("span").text().trim();

  //convert to momnt object at 5:00pm
...
$(".list-group").on("click", "span", function() {
  ...
  var dateInput = $("<input>")
    ...
    dateInput.datepicker({
      minDate: 1,
      onClose: function() {
        //when calendar is closed, force a "change" enevt on the 'dateInput'
        $(this).trigger("change");
      }
    });
...
var date =$(this)
  ...
  //replace text area with span element
